...
@section('content')
    <div class="container mx-auto py-10">
        ...
        <div class="flex justify-center mb-12">
            <div class="w-1/2 p-4">
                <img src="{{ asset('image/logodepko.png') }}" alt="Department Logo" class="rounded-md mx-auto">
            </div>
            <div class="w-1/2 p-4">
                <img src="{{ asset('image/prodepko.png') }}" alt="Department Event" class="rounded-md mx-auto">
            </div>
        </div>
        ...
        <div class="text-center mb-12">
            <div class="flex justify-center space-x-8">
                ...
                <div>
                    ...
                    <p class="text-lg font-bold">wakil kepala divisi</p>
