...
<head>
  ...
  <link rel="shortcut icon" href="image/fevicon.png" type="">
...
<body>
  ...
  <section class="track_section layout_padding">
    <div class="track_bg_box">
      <img src="image/track-bg.jpg" alt="">
    </div>
    <div class="container">
      <div class="row">
        <div class="col-md-6">
          ...
          <div class="owl-carousel">
            <div class="item">
              <div class="box">
                ...
                <div class="client_id">
                  <div class="img-box">
                    <img src="image/client-1.png" alt="" class="img-1">
                  </div>
                  <div class="name">
                    <h6>
                      Adipiscing
            ...
            <div class="item">
              <div class="box">
                ...
                <div class="client_id">
                  <div class="img-box">
                    <img src="image/client-2.png" alt="" class="img-1">
                  </div>
                  <div class="name">
                    <h6>
                      Adipiscing
          ...
          <div class="info_link_box">
            ...
            <div class="info_links">
              <a class="active" href="index.html">
                <img src="image/nav-bullet.png" alt="">
                Home
              </a>
